<?php
    ...
    function getJson($ip, $db, $us, $ps) {
        ...
        $sql  = "Select a.branch_id, b.name as branchname, do_code, po_code, status, convert(varchar(10), postingdate, 20) as postingdate,
        ...
        if ($result) {
          ...
          while( $row = sqlsrv_fetch_array( $result, SQLSRV_FETCH_ASSOC) ) {
            ...
            $out[] = array("branch_id" => $branch_id, "branchname" => $branchname,
                           ...
                           "deliverydate" => $deliverydate, "vendor_code" => $vendor_code,
                           "vendorname" => $vendorname,"remarks" => $remarks);
            $no++;
          }
        } else {
          $out[] = array("branch_id" => "", "branchname" => "",
                         "do_code" => "", "po_code" => "", "status" => "", "postingdate" => "",
